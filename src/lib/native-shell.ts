...
export const NATIVE_SHELL_BOOT_SCRIPT = `(function(){try{var k="zumelia-native-shell",c="zumelia-capacitor-shell";var q=location.search||"",ua=navigator.userAgent||"",p=location.pathname||"/";var cap=q.indexOf("native=1")>=0||q.indexOf("app=native")>=0||/ZumeliaNativeApp/i.test(ua)||(window.Capacitor&&((window.Capacitor.isNativePlatform&&window.Capacitor.isNativePlatform())||window.Capacitor.getPlatform&&(window.Capacitor.getPlatform()==="android"||window.Capacitor.getPlatform()==="ios")));var native=cap||window.matchMedia("(display-mode: standalone)").matches||window.navigator.standalone===true;if(cap)localStorage.setItem(c,"1");if(native){localStorage.setItem(k,"1");document.documentElement.setAttribute("data-zumelia-native","1");if(cap&&(p==="/"||p==="")){location.replace("/login");return}}else if(localStorage.getItem(k)==="1"){document.documentElement.setAttribute("data-zumelia-native","1")}}catch(e){}})();`;
