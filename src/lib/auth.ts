...
export function normalizeProfile(row: Record<string, unknown>): Profile {
  ...
  return {
    ...
    business_auto_reply_mode: (p.business_auto_reply_mode ?? "template") as Profile["business_auto_reply_mode"],
    business_auto_reply_max_count: p.business_auto_reply_max_count ?? 1,
    business_auto_reply_hours_start: p.business_auto_reply_hours_start ?? null,
    business_auto_reply_hours_end: p.business_auto_reply_hours_end ?? null,
    business_featured: p.business_featured ?? false,
    business_featured_at: p.business_featured_at ?? null,
    is_verified: p.is_verified ?? false,
    verified_at: p.verified_at ?? null,
    verified_category: (p.verified_category ?? null) as Profile["verified_category"],
